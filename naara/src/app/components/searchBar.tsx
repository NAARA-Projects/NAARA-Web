...
export const SearchInput = ({ customClass, classInput }) => {
    return (
        <div className={`bg-[#D9D9D90D] outline-none w-full h-[38px] rounded-full border border-[#FFFFFF0D] inline-flex px-2 ${customClass}`}>
