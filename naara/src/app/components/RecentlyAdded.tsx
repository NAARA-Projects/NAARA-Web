...
const RecentlyAdded = ({ number, orgName, eventName, image }) => {
  return (
    <div className="flex-row flex items-center justify-center m-1">
      ...
      <div className="flex-row flex items-center justify-center p-2 bg-[#D9D9D91A] rounded-lg w-[300px]">
          ...
          <div className="flex-col flex justify-start ml-3">
            ...
            <p className="font-segoe text-ellipsis overflow-hidden text-nowrap text-[#FFFFFF80] text-[14px] w-[230px]">{eventName}</p>
          </div>
        </div>
    </div>
  );
