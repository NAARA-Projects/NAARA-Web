...
const RecentlyAdded = ({ eventName, eventDesc, image, userIcon, userName }) => {
  ...
  return (
    <div className="flex-col flex items-center justify-center m-1 w-[350px] bg-[#FFFFFF1A] rounded-lg">
      <div className="flex-row flex items-start justify-center">
        ...
        <div>
          ...
          <p className={`w-[250px] font-segoe font-[13px] text-[#FFFFFF99] text-ellipsis overflow-hidden inline-block ${styles.twoline}`} class>{eventDesc}</p>
        </div>
      </div>
      <div className="flex-row">
        <div className="flex-row flex">
          <Image src={userIcon} alt={"usericon"} width={18} height={18} className="w-[18px] h-[18px] mt-0.5"/>
