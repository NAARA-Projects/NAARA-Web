...
const Footer = () => {
    return(
        <footer className="flex flex-col pt-custom-padding-44 pb-custom-padding-45 pl-custom-padding-44 pr-custom-padding-36 border-t bg-black to-transparent">
                ...
                <div className="flex flex-col justify-start items-start gap-y-custom-gap-15">
                    ...
                    <div className="text-sm text-white opacity-50 font-segoe font-thin flex flex-col gap-y-custom-gap-12">
                        <div className="flex flex-col">
                            ...
                            <p>
                                Kota Bks, Jawa Barat 17156, Indonesia
                            </p>
                        </div>
                        <p>
                            +62 817-5172-221
                    ...
                    <div className="flex flex-row gap-x-custom-gap-51">
                        <div className="flex flex-col gap-y-custom-gap-12 h-custom-height-27">
                            <div className="flex flex-row gap-x-custom-gap-12">
                                ...
                                <p className="font-segoe font-thin text-sm h-full">@NAARAProjects</p>
                            </div>
                            <div className="flex flex-row gap-x-custom-gap-12">
                                <img src="/instaLogo.svg" alt="Instagram" className="h-full object-contain"></img>
                                <p className="font-segoe font-thin text-sm h-full">naaraprojects.id</p>
                            </div>
                        </div>
                        <div className="flex flex-col gap-y-custom-gap-12 h-custom-height-27">
                            <div className="flex flex-row gap-x-custom-gap-12">
                                <img src="/linkedinLogo.svg" alt="linkedin" className="h-full object-contain"></img>
                                <p className="font-segoe font-thin text-sm h-full"><u>https://www.linkedin.com/company/naaraprojects</u></p>
                            </div>
                            <div className="flex flex-row gap-x-custom-gap-12">
                                <img src="/linktreeLogo.svg" alt="Linktree" className="h-full object-contain"></img>
                                <p className="font-segoe font-thin text-sm h-full"><u>https://linktr.ee/naaraprojects</u></p>
                            </div>
                        </div>
                    </div>
                </div>
