        ...
        <main className='w-full h-full min-h-screen z-0 bg-customBlack'>
            ...
            <div className="flex flex-row"> {/*All Bottom Part*/}
                <div className="w-[668]">
                    ...
                    <div className="ml-52 mt-8"> {/* Delete Account */}
                        <div className="flex flex-col gap-y-7">
                            <p className="font-segoe font-extralight text-3xl tracking-tight text-white"> Delete Account</p>
                            <p className="text-lg py-4 font-segoe font-extralight text-white opacity-60">Click REQUEST ACCOUNT DELETE to start the process of permanently deleting your naara. account including all of its personal information. If you request to delete your account, your account will be deleted in 14 days. During this time, you can login to reactivate your account, which will cancel your deletion. After 14 days deletion will be irreversible.</p>
                        </div>
